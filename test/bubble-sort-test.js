...
describe('bubble sort functionality', () => {
  context('bubbleSort function', () => {
    ...
    it('displays expected console output', () => {
      assert.include(output, '\u001b[35mBegin sorting:\u001b[39m\n');
      assert.include(output, 'Index 5 is sorted.\n')
      assert.include(output, 'Index 4 is sorted.\n')
      assert.include(output, 'Index 3 is sorted.\n')
      assert.include(output, 'Index 2 is sorted.\n')
      assert.include(output, '\u001b[32mBubble sort complete.\u001b[39m\n')
    });
  });
});
